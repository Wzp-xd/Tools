...
WeaponDefs.DEFS = {
    ...
    machinegun = {
        ...
        -- 弹丸视觉
        bulletScale = Vector3(0.06, 0.06, 1.2),
    ...
    missile = {
        ...
        description = "斜向 60° 发射飞弹，6 发连射。\n可锁定多个目标后齐射。\n发射后飞弹具有追踪效果。",
        usage = "锁定多个目标后释放齐射，飞弹自动追踪。",
    },
    ...
    vertical_missile = {
        ...
        usage = "锁定多个目标后释放齐射，飞弹垂直升空后自动追踪俯冲。",
    },
