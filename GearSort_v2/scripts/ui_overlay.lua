    ...
    local hud = UI.Panel {
        ...
        children = {
            ...
            UI.Button {
                ...
                backgroundImage = "image/btn_menu_20260601091525.png",
                    ...
                    UI.Panel {
                        ...
                        children = {
                            ...
                            UI.Panel {
                                ...
                                height = "130%",
                                aspectRatio = 379 / 211,
                                backgroundImage = "image/btn_secondary_small_20260601091616.png",
                                backgroundFit   = "fill",
                                pointerEvents = "none",
                            },
                            -- 文字：独立 UI，字号降低 25%
    ...
    local winPanel = UI.Panel {
        ...
        children = {
            UI.Panel {
                ...
                backgroundImage = "image/popup_panel_20260601091741.png",
                backgroundFit   = "fill",
                alignItems = "center",
                gap = 10,
                children = {
                    ...
                    UI.Panel {
                        ...
                        backgroundImage    = "image/win_title_banner_20260601091223.png",
                        backgroundFit   = "contain",
                    },
                    -- 标题下分隔线
                    UI.Panel {
                    ...
                    UI.Panel {
                        ...
                        children = {
                            UI.Panel {
                                id = "winCoinIcon",
                                width = 36, height = 36,
                                backgroundImage = "image/icon_merit_reward_20260601091036.png",
                                backgroundFit   = "contain",
                            },
                            UI.Label {
                                id = "winCoinsLabel",
                    ...
                    UI.Panel {
                        ...
                        children = {
                            ...
                            UI.Button {
                                ...
                                fontSize        = 24,
                                backgroundImage = "image/btn_emboss_20260601091503.png",
                                backgroundFit   = "fill",
                                onClick = function()
            ...
            UI.Panel {
                ...
                children = {
                    ...
                    UI.Panel {
                        ...
                        backgroundImage = "image/pause_deco_20260601092136.png",
                        backgroundFit = "contain",
                        marginTop = "auto",
                        marginBottom = 8,
                    },
