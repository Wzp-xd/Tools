...
local function PrimaryButton(opts)
    return UI.Button {
        ...
        backgroundImage    = "image/topbar_bg_20260601091708.png",
        backgroundFit   = "fill",
        borderWidth = 0,
        padding = 0,
        flexDirection  = "row",
        ...
        children = {
            ...
            UI.Panel {
                ...
                children = {
                    UI.Panel {
                        width           = 36, height = 36,
                        backgroundImage = "image/avatar_hanxin_20260601091914.png",
                        backgroundFit   = "contain",
                    },
                },
            },
    ...
    return UI.Panel {
        ...
        children = {
            UI.Panel {
                id              = "topBarCoinIcon",
                width           = 32, height = 32,
                backgroundImage = "image/icon_merit_20260601091032.png",
                backgroundFit   = "contain",
            },
            UI.Label {
                id         = "topBarCoinLabel",
    ...
    return UI.Panel {
        ...
        children = {
            UI.Panel {
                width  = 440,
                height = 440,
                backgroundImage    = "image/logo_hanxin_20260601091227.png",
                backgroundFit   = "contain",
            },
        },
    }
...
local function buildButtons()
    ...
    -- 按钮背景图原始尺寸 715×194，根据实际宽度等比算高度
    local IMG_W, IMG_H = 715, 194
    local dpr        = graphics:GetDPR() or 1
    local screenW    = graphics:GetWidth() / dpr
    ...
    local fsMain     = math.max(10, math.floor(33 * fontScale))
    local fsSub      = math.max(8,  math.floor(20 * fontScale))
                ...
                children = {
                    UI.Panel {
                        ...
                        children = {
                            ...
                            UI.Label {
                                text      = string.format("Lv.%d", currentLevel),
                                fontSize  = fsSub,
                                fontColor = { 180, 215, 255, 200 },
                            },
                        },
                    },
                },
...
local function buildCheckInDialog()
    ...
    local confirmBtn = UI.Button {
        ...
        fontSize        = 18,
        backgroundImage = alreadyDone and nil or "image/btn_emboss_20260601091503.png",
        backgroundFit   = "fill",
        ...
        children = {
            UI.Panel {
                ...
                children = {
                    ...
                    UI.Panel {
                        width  = 80, height = 80,
                        backgroundImage = "image/icon_gift_20260601091910.png",
                        backgroundFit   = "contain",
                    },
                    -- 标题
                    UI.Label {
...
local function switchTab(tabId)
    ...
    for id, panel in pairs(navTabs_) do
        ...
        panel.props.backgroundImage = active
            and "image/btn_primary_20260601091448.png"
            or  "image/btn_secondary_20260601091503.png"
                ...
                children = {
                    UI.Panel {
                        ...
                        children = {
                            UI.Panel {
                                width = 44, height = 44,
                                backgroundImage = "image/icon_undo_order_20260601091120.png",
                                backgroundFit = "contain",
                            },
                            UI.Panel {
                                gap = 2,
                ...
                children = {
                    UI.Panel {
                        ...
                        children = {
                            UI.Panel {
                                width = 44, height = 44,
                                backgroundImage = "image/icon_camp_order_20260601091034.png",
                                backgroundFit = "contain",
                            },
                            UI.Panel {
                                gap = 2,
    ...
    return UI.Panel {
        ...
        children = {
            ...
            UI.Panel {
                position = "absolute",
                top = 0, left = 0, right = 0, bottom = 0,
                backgroundImage = "image/bg_menu_main_20260601090919.png",
                backgroundFit = "cover",
                opacity = 0.4,
            },
            -- 内容区
...
local function buildBagPanel()
    ...
    local undoCard = buildItemCard({
        icon      = "image/icon_undo_order_20260601091120.png",
        name      = "撤回道具",
        desc      = "撤销上一步操作，在游戏中使用",
...
local function buildLevelSelect()
    ...
    for i = 1, Levels.Count() do
        ...
        local bgSrc = (not isLocked and isCleared)
            and "image/cell_cleared_20260601092223.png"
            or  "image/cell_locked_20260601092224.png"
    ...
    if taskUndoClaimBtn_ then
        ...
        taskUndoClaimBtn_.props.onClick = canClaim and function(self)
            ...
            if btnOk and btnLayout and dstX then
                ...
                playItemFly("image/icon_undo_order_20260601091120.png", sx, sy, dstX, dstY, function()
                    MainMenu.RefreshBagPanel()
                end)
            end
            -- 卡片刷新特效
    ...
    if taskHubClaimBtn_ then
        ...
        taskHubClaimBtn_.props.onClick = canClaim and function(self)
            ...
            if btnOk and btnLayout and dstX then
                local sx = btnLayout.x + btnLayout.w * 0.5
                local sy = btnLayout.y + btnLayout.h * 0.5
                playItemFly("image/icon_camp_order_20260601091034.png", sx, sy, dstX, dstY, function()
                    MainMenu.RefreshBagPanel()
                end)
            end
            -- 卡片刷新特效
